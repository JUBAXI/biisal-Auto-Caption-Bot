...
BOT_TOKEN = str(getenv("BOT_TOKEN", "7068966315:AAFGZByhTfEM7YOGS-mCjRYtlbQPfdDfAjQ"))
MONGO_DB = str(
    getenv(
        "MONGO_DB",
        "mongodb+srv://Gustavo:IWdSRM75R0atDNhG@gusvato.zya2mso.mongodb.net/?retryWrites=true&w=majority&appName=Gusvato",
    )
)
DEF_CAP = str(
    getenv(
